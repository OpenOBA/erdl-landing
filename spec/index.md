...
>
> 版本：1.0 (Community Preview) · 2026-07-04
> 维护者：OpenOBA
> 许可证：MIT
...
**ERDL 不与 MCP/A2A 竞争。** 三层互补，构成完整的 Agent 互操作基础设施：

```
┌──────────────────────────────────┐
│  A2A  — Agent ↔ Agent 通信标准   │  Google · LF · 150+ orgs
├──────────────────────────────────┤
│  ERDL — Agent 行为规则标准       │  OpenOBA · MIT
├──────────────────────────────────┤
...
- **EU AI Act (2026.8.2 全面生效)** — 高风险 AI 系统的透明度和人工监督要求
...
- EU, "AI Act", Regulation 2024/1689, effective 2026.8.2
